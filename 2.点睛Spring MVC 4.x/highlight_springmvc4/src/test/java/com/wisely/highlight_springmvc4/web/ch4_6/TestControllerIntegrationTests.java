...
@WebAppConfiguration("src/main/resources") //1 @WebAppConfiguration注解在类上，用来声明加载的ApplicationContext是一
											  // 个WebApplicationContext。它的属性指定的是Web资源的位置，默认为src/main/webapp,
...
public class TestControllerIntegrationTests {
    ...
    public void setup() {
    	mockMvc =
    			MockMvcBuilders.webAppContextSetup(this.wac).build(); //2 mockMvc模拟MVC对象，通过
																	// MockMvcBuilders.webAppContextSetup(this.wac).build()初始化
    	}
	...
	public void testNormalController() throws Exception{
		mockMvc.perform(get("/normal")) //8 模拟向/normal进行get请求
				...
				.andExpect(forwardedUrl("/WEB-INF/classes/views/page.jsp"))//11 预期页面转向的真正路径
																							// 为/WEB-INF/classes/views/page.jsp
